...
func MsRdpClient9NotSafeForScripting_SetOnDisconnected(obj uintptr, fn interface{}) {
    msRdpClient9NotSafeForScripting_SetOnDisconnected.Call(obj, addEventToMap(fn))
}
