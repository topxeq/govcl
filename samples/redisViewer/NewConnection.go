...
type TNewConnection struct {
    *vcl.TForm
    Panel1            *vcl.TPanel
    BtnTestConnection *vcl.TButton
    BtnOk             *vcl.TButton
    BtnCancel         *vcl.TButton
    Panel2            *vcl.TPanel
    Label1            *vcl.TLabel
    EdtConnName       *vcl.TEdit
    Label2            *vcl.TLabel
    EdtHost           *vcl.TEdit
    Label3            *vcl.TLabel
    EdtPort           *vcl.TEdit
    Label5            *vcl.TLabel
    EdtPassword       *vcl.TEdit
...
// 以字节形式加载
// vcl.Application.CreateForm(&NewConnection)

func NewNewConnection(owner vcl.IComponent) (root *TNewConnection)  {
...
// 注册Form资源
var _ = vcl.RegisterFormResource(NewConnection, &newConnectionBytes)
