  ...
  try
    ...
    try
      ...
      begin
        ...
        begin
          LListStr.Add('import (');
          LListStr.Add('    "github.com/topxeq/govcl/vcl"');
          LListStr.Add(')');
        end;
      end else
      begin
           ...
           begin
             ...
             begin
               ...
               begin
                 Inc(I);
                 LListStr.Insert(I, ')');
                 LListStr.Insert(I, '    "github.com/topxeq/govcl/vcl"');
      ...
      // 这里检查下是否需要类型包
      if not LListStr.Text.Contains('"github.com/topxeq/govcl/vcl/types"') then
      begin
        for LItem in AEvents do
        begin
          ...
          begin
            ...
            begin
              if LTemp.Contains('"github.com/topxeq/govcl/vcl"') then
              begin
                LListStr.Insert(I + 1, '    "github.com/topxeq/govcl/vcl/types"');
                Break;
              end;
              Inc(I);
            end;
...
{$ENDIF}
  try
    ...
    WLine;
    WLine('import (');
    WLine('    "github.com/topxeq/govcl/vcl"');
    WLine(')');
    WLine;
...
begin
  ...
  try
    ...
    begin
      ...
      LMainDotGo.Add('    "github.com/topxeq/govcl/vcl"');
      ...
      // winappres
      if LOutWinRes then
         LMainDotGo.Add('    _ "github.com/topxeq/govcl/pkgs/winappres"');
      LMainDotGo.Add(')');
      LMainDotGo.Add('');
